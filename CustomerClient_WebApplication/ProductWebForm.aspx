<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductWebForm.aspx.cs" Inherits="CustomerClient_WebApplication.ProductWebForm" %>
    ...
    <form id="form1" runat="server">
       ...
       <div class ="form-horizontal">
           ...
           <div class ="form-group">
               <asp:Label ID="Label1" runat="server" CssClass ="col-md-2 control-label" Text="Flower Id"></asp:Label>
               <div class ="col-md-3">
           ...
           <div class ="form-group">
               <asp:Label ID="Label2" runat="server" CssClass ="col-md-2 control-label" Text="Flower Name" ></asp:Label>
               <div class ="col-md-3">
